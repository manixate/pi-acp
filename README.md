...
- Bridges pi extension dialogs (`select`, `confirm`, `input`, and `editor`) to ACP form elicitation when the client advertises support; `select` and `confirm` retain permission-request fallbacks for older clients
